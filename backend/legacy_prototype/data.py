# legacy_prototype/data.py
# Early Stage 1 Prototype: 12 sample posts across 12 distinct topics.
# Note: Active production uses PostgreSQL db/seed.sql and frontend/src/data/extendedFeed.js.
